...
[importer](/guides/importer-workflow) or defined directly as
[`SimpleGeometry`](/concepts/simple-geometry).
...
- Defining outlines by hand (lines and arcs)? See [SimpleGeometry](/concepts/simple-geometry)
  for the shape and how to package it.
